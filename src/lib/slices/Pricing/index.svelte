...
<section class=" pb-28">
	<div class="box-big hidden md:grid grid-cols-1 md:grid-cols-3 gap-6" data-aos="fade-up">
		{#each slice.primary.items as item, index}
			<div data-aos="fade-zoom-in" data-aos-delay={100 + index * 150} class=" card   rounded-lg px-8 pt-10 pb-14 transition-colors duration-200 color-transition  bg-[var(--secondary-color)] md:hover:bg-[var(--tertiary-color)] ">
	...
	<div class="block md:hidden" data-aos="fade-up">
		<Slider>
			{#each slice.primary.items as item, index}
				<div data-aos="fade-zoom-in" data-aos-delay={100 + index * 150} class="item rounded-lg px-8 pt-10 pb-14 color-transition transition-colors duration-200  bg-[var(--secondary-color)] md:hover:bg-[var(--tertiary-color)] " style={calculateStyles(index, slice.primary.items.length)}>
					<div class="flex flex-col justify-between h-full ">
						<div>
							<h3 class="text-center border-b mb-6 border-[var(--text-quaternary-color)]" data-aos="fade" data-aos-delay={index * 250}>
								{item.headline}
