<script lang="ts">
    ...
    if (typeof window !== 'undefined') {
        ...
        img.src = `data:image/svg+xml;utf8,<svg viewBox='0 0 591.82 276.38' xmlns='http://www.w3.org/2000/svg'><path d='${maskPath}' fill='white'/></svg>`;
    }
