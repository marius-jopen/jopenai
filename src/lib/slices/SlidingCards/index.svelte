	...
	<div data-aos="fade-up">
		<Slider>
			{#each items as item, index}
				<div data-aos="fade-zoom-in" data-aos-delay={200 + index * 500} class="item lg:flex flex-col lg:flex-row rounded-lg overflow-hidden" style={calculateStyles(index, items.length)}>
